...
function ShowMyProfile() {
  ...
  AccountHtml +=
    "<div><input id=Configure_Account_wssServer class=UiInputText type=text placeholder='" +
    lang.eg_asterisk_server_address +
    "' value='" +
    getDbItem('wssServer', '') +
    "'></div>";
  ...
  AccountHtml +=
    "<div><input id=Configure_Account_WebSocketPort class=UiInputText type=text placeholder='" +
    lang.eg_websocket_port +
    "' value='" +
    getDbItem('WebSocketPort', '') +
    "'></div>";

  AccountHtml += '<div class=UiText>' + lang.websocket_path + ':</div>';
  AccountHtml +=
    "<div><input id=Configure_Account_ServerPath class=UiInputText type=text placeholder='" +
    lang.eg_websocket_path +
    "' value='" +
    getDbItem('ServerPath', '') +
    "'></div>";
  ...
  AccountHtml +=
    "<div><input id=Configure_Account_SipDomain class=UiInputText type=text placeholder='" +
    lang.eg_sip_domain +
    "' value='" +
    getDbItem('SipDomain', '') +
    "'></div>";
  ...
  AccountHtml +=
    '<div><input type=checkbox id=Configure_Account_Voicemail_Subscribe ' +
    (VoiceMailSubscribe == true ? 'checked' : '') +
  ...
  AccountHtml +=
    '<div style="margin-left:20px"><input id=Configure_Account_Voicemail_Did class=UiInputText type=text placeholder=\'' +
    lang.eg_internal_subscribe_extension +
    "' value='" +
    getDbItem('VoicemailDid', '') +
    "'></div>";
  AccountHtml += '</div>';
  ...
  AccountHtml +=
    '<li><input type=radio name=chatEngine id=chat_type_sip ' +
    (ChatEngine == 'XMPP' ? '' : 'checked') +
    '><label for=chat_type_sip>SIP</label>';
  AccountHtml +=
    '<li><input type=radio name=chatEngine id=chat_type_xmpp ' +
    (ChatEngine == 'XMPP' ? 'checked' : '') +
  ...
  AccountHtml +=
    "<div><input id=Configure_Account_xmpp_address class=UiInputText type=text placeholder='" +
    lang.eg_xmpp_server_address +
    "' value='" +
    getDbItem('XmppServer', '') +
    "'></div>";

  AccountHtml += '<div class=UiText>XMPP ' + lang.websocket_port + ':</div>';
  AccountHtml +=
    "<div><input id=Configure_Account_xmpp_port class=UiInputText type=text placeholder='" +
    lang.eg_websocket_port +
    "' value='" +
    getDbItem('XmppWebsocketPort', '') +
    "'></div>";

  AccountHtml += '<div class=UiText>XMPP ' + lang.websocket_path + ':</div>';
  AccountHtml +=
    "<div><input id=Configure_Account_xmpp_path class=UiInputText type=text placeholder='" +
    lang.eg_websocket_path +
    "' value='" +
    getDbItem('XmppWebsocketPath', '') +
    "'></div>";

  AccountHtml += '<div class=UiText>XMPP ' + lang.sip_domain + ':</div>';
  AccountHtml +=
    "<div><input id=Configure_Account_xmpp_domain class=UiInputText type=text placeholder='" +
    lang.eg_sip_domain +
    "' value='" +
    getDbItem('XmppDomain', '') +
    "'></div>";

  AccountHtml += '<div class=UiText>' + lang.extension_number + ':</div>';
  AccountHtml +=
    "<div><input id=Configure_Account_profileUser class=UiInputText type=text placeholder='" +
    lang.eg_internal_subscribe_extension +
    "' value='" +
    getDbItem('profileUser', '') +
    "'></div>";
  AccountHtml += '</div>';
  ...
  // 2 Audio & Video
  html +=
    '<div class=UiTextHeading onclick="ToggleHeading(this,\'Audio_Video_Html\')"><i class="fa fa fa-video-camera UiTextHeadingIcon" style="background-color:#208e3c"></i> ' +
    lang.audio_video +
    '</div>';
  ...
  if (EnableVideoCalling == true) {
    ...
    AudioVideoHtml += '<div class=pill-nav>';
    AudioVideoHtml +=
      '<input name=Settings_Orientation id=r20 type=radio value="rotateY(0deg)"><label class=radio_pill for=r20><i class="fa fa-address-card" style="transform: rotateY(0deg)"></i> ' +
      lang.image_orientation_normal +
      '</label>';
    AudioVideoHtml +=
      '<input name=Settings_Orientation id=r21 type=radio value="rotateY(180deg)"><label class=radio_pill for=r21><i class="fa fa-address-card" style="transform: rotateY(180deg)"></i> ' +
      lang.image_orientation_mirror +
      '</label>';
    AudioVideoHtml += '</div>';
  ...
  if (EnableAppearanceSettings == true) {
    html +=
      '<div class=UiTextHeading onclick="ToggleHeading(this,\'Appearance_Html\')"><i class="fa fa-pencil UiTextHeadingIcon" style="background-color:#416493"></i> ' +
      lang.appearance +
      '</div>';
  }
  ...
  AppearanceHtml +=
    "<div><input id=Configure_Profile_TitleDesc class=UiInputText type=text placeholder='" +
    lang.eg_general_manager +
    "' value='" +
    (profileVcard != null ? profileVcard.TitleDesc : '') +
    "'></div>";
  AppearanceHtml += '<div class=UiText>' + lang.mobile_number + ':</div>';
  AppearanceHtml +=
    "<div><input id=Configure_Profile_Mobile class=UiInputText type=text placeholder='" +
    lang.eg_mobile_number +
    "' value='" +
    (profileVcard != null ? profileVcard.Mobile : '') +
    "'></div>";
  AppearanceHtml += '<div class=UiText>' + lang.email + ':</div>';
  AppearanceHtml +=
    "<div><input id=Configure_Profile_Email class=UiInputText type=text placeholder='" +
    lang.email +
    "' value='" +
    (profileVcard != null ? profileVcard.Email : '') +
    "'></div>";
  AppearanceHtml += '<div class=UiText>' + lang.contact_number_1 + ':</div>';
  AppearanceHtml +=
    "<div><input id=Configure_Profile_Number1 class=UiInputText type=text placeholder='" +
    lang.eg_contact_number_1 +
    "' value='" +
    (profileVcard != null ? profileVcard.Number1 : '') +
    "'></div>";
  AppearanceHtml += '<div class=UiText>' + lang.contact_number_2 + ':</div>';
  AppearanceHtml +=
    "<div><input id=Configure_Profile_Number2 class=UiInputText type=text placeholder='" +
    lang.eg_contact_number_2 +
    "' value='" +
    (profileVcard != null ? profileVcard.Number2 : '') +
    "'></div>";
  ...
  if (EnableNotificationSettings == true) {
    html +=
      '<div class=UiTextHeading onclick="ToggleHeading(this,\'Notifications_Html\')"><i class="fa fa-bell UiTextHeadingIcon" style="background-color:#ab8e04"></i> ' +
      lang.notifications +
      '</div>';
  }
